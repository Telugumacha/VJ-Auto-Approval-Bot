...
async def approve(_, m : Message):
    ...
    try:
        ...
        await app.send_video(kk.id,img, "**Hello {}!\nWelcome To {}\n\n__Powerd By : @Telugumacha_updates__**".format(m.from_user.mention, m.chat.title))
        add_user(kk.id)
    ...
    try:
        ...
        if m.chat.type == enums.ChatType.PRIVATE:
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("🗯 Channel", url="https://t.me/Telugumacha_updates"),
                        InlineKeyboardButton("💬 Support", url="https://t.me/+ssJ5h4EZqqs4ZmE9")
                    ],[
                        InlineKeyboardButton("➕ Add me to your Chat ➕", url="https://t.me/Telugumacha_autoapprovebot?startgroup")
                    ]
                ]
            )
            ...
            keyboar = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("💁‍♂️ Start me private 💁‍♂️", url="https://t.me/Telugumacha_autoapprovebot?startgroup")
                    ]
                ]
            )
            add_group(m.chat.id)
